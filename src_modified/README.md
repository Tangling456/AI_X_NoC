...
> Note: the Lab asks for `2GHz`. However, in the follow-up experiments
> (Labs 2–4) the global frequency is kept unified with the simulation clock
> (1 GHz; with this configuration 1 cycle = 1 tick), so the working tree has
> been set to `1GHz`. All results in labs 2-4 were generated with this
> unified `1GHz` setting.
